...
#ifdef VENDOR_EDIT
//liujia@Mutilmedia.AudioDriver, 2020/07/06, modify for headset
...
//#ifdef ODM_HQ_EDIT
/*liujia@ODM_HQ.Multimidia.Auido.mbhc 2020/04/27 disable mbhc moisture*/
					  ...
					  bool enable)
{
	if (enable) {
		...
		#ifndef VENDOR_EDIT
		//liujia@ODM_HQ.Multimidia.Auido.mbhc 2020/07/29 avoid pull in noise
		snd_soc_component_update_bits(component, WCD937X_HPH_PA_CTL2,
				    0x40, 0x00);
		snd_soc_component_update_bits(component, WCD937X_HPH_PA_CTL2,
				    0x10, 0x00);
