...
//#ifdef ODM_HQ_EDIT
/* Yin.Zhang@ODM_HQ.Multimidia.Audio, 2020/04/30, Add sia81xx for soda */
...
//wangbin@Mutilmedia.AudioDriver, 2020/07/01, modify for headset
#ifdef VENDOR_EDIT
...
//#ifdef ODM_HQ_EDIT
/*liujia@ODM_HQ.Multimidia.Audio.bringup 2020/04/27 bringup audio pa*/
//add for Awinic pa 87339 rcv
...
static int aw87339_rcv_kspk_control = 0;
static int aw87339_rcv_drcv_control = 0;
...
static int ext_top_speaker_amp_get(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	ucontrol->value.integer.value[0] = aw87339_rcv_kspk_control;
	pr_debug("%s: aw87339_rcv_kspk_control = %d\n", __func__,
		aw87339_rcv_kspk_control);
	return 0;
}
...
static int ext_top_speaker_amp_put(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	if(ucontrol->value.integer.value[0] == aw87339_rcv_kspk_control){
		return 1;
	}
	aw87339_rcv_kspk_control = ucontrol->value.integer.value[0];
	if(ucontrol->value.integer.value[0]) {
		if(awinic_rcv_audio_spk_pf != NULL)
			{
				awinic_rcv_audio_spk_pf();
			}
	} else {
		if(awinic_rcv_audio_spk_off_pf != NULL)
			{
				awinic_rcv_audio_spk_off_pf();
			}
	}
...
static int ext_receiver_amp_get(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	ucontrol->value.integer.value[0] = aw87339_rcv_drcv_control;
	pr_debug("%s: aw87339_rcv_drcv_control = %d\n", __func__,
		aw87339_rcv_drcv_control);
	return 0;
}
...
static int ext_receiver_amp_put(struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	if(ucontrol->value.integer.value[0] == aw87339_rcv_drcv_control){
		return 1;
	}
	aw87339_rcv_drcv_control = ucontrol->value.integer.value[0];
	if(ucontrol->value.integer.value[0]) {
		if(awinic_rcv_audio_rcv_pf != NULL)
			{
				awinic_rcv_audio_rcv_pf();
			}
	} else {
		if(awinic_rcv_audio_spk_off_pf != NULL)
			{
...
static int aw87339_spk_kspk_control = 0;
...
static int ext_bottom_speaker_amp_get(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	ucontrol->value.integer.value[0] = aw87339_spk_kspk_control;
	pr_debug("%s: aw87339_kspk_control = %d\n", __func__,
		aw87339_spk_kspk_control);
	return 0;
}
...
static int ext_bottom_speaker_amp_put(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	if(ucontrol->value.integer.value[0] == aw87339_spk_kspk_control){
		return 1;
	}
	aw87339_spk_kspk_control = ucontrol->value.integer.value[0];
	if(ucontrol->value.integer.value[0]) {
		if(awinic_spk_audio_spk_pf != NULL)
			{	
				awinic_spk_audio_spk_pf();
			}
	} else {
		if(awinic_spk_audio_spk_off_pf != NULL)
			{
				awinic_spk_audio_spk_off_pf();
			}
	}
	pr_debug("%s: value.integer.value = %d\n", __func__,
		ucontrol->value.integer.value[0]);
...
// Ming.Liu@PSW.MM.AudioDriver.feature.1446118, 2020/07/26, Add for PA_BOOST_VOLTAGE
// #ifdef OPPO_AUDIO_PA_BOOST_VOLTAGE
static int aw87339_rcv_voltage = 80;
static int aw87339_spk_voltage = 80;
...
static int ext_top_speaker_voltage_get(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	ucontrol->value.integer.value[0] = aw87339_rcv_voltage;
...
static int ext_top_speaker_voltage_put(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	if (ucontrol->value.integer.value[0] == aw87339_rcv_voltage){
		return 1;
	}

	aw87339_rcv_voltage = ucontrol->value.integer.value[0];
...
static int ext_bottom_speaker_voltage_get(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	ucontrol->value.integer.value[0] = aw87339_spk_voltage;
...
static int ext_bottom_speaker_voltage_put(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	if(ucontrol->value.integer.value[0] == aw87339_spk_voltage){
		return 1;
	}

	aw87339_spk_voltage = ucontrol->value.integer.value[0];
	if(awinic_set_spk_voltage_pf != NULL)
		{
			awinic_set_spk_voltage_pf(ucontrol->value.integer.value[0]);
		}
...
//add for Awinic pa 87339 spk & 87519 rcv
...
//#ifdef ODM_HQ_EDIT
/*liujia@ODM_HQ.Multimidia.Audio.bringup 2020/04/27 bringup audio pa*/
	//add for Awinic pa 87339 spk & 87339 rcv
...
//#endif /* ODM_HQ_EDIT */
	...
	// Ming.Liu@PSW.MM.AudioDriver.feature.1446118, 2020/07/26, Add for PA_BOOST_VOLTAGE
	// #ifdef OPPO_AUDIO_PA_BOOST_VOLTAGE
	SOC_ENUM_EXT("Ext_TOP_Speaker_Voltage", msm_snd_enum[3],
			ext_top_speaker_voltage_get, ext_top_speaker_voltage_put),
	SOC_ENUM_EXT("Ext_BOTTOM_Speaker_Voltage", msm_snd_enum[4],
